...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(HomeDashboard.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]

namespace HomeDashboard.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fontawesome").Include("~/Content/fontawesome/all.css"));
		}
	}
}